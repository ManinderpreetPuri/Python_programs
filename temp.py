...
"""
# Task 1:
# Write a Python program to calculate the volume of a can of soft drink. Ask the user 
# for the diameter and height. Then, display the volume using formatted print (e.g., the 
# volume of diameter and height is ??? )
# 
# - volume = area * height
# - area = 1/4 * 3.14 * diameter^2

dia = int(input('Diameter of can='))
height = int(input('Height of can='))
